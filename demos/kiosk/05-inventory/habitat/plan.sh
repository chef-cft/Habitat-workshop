...
pkg_svc_user="root"
pkg_svc_group="root"
pkg_svc_run="${pkg_name} 8004 default"
pkg_bin_dirs=(bin)
...
do_install() {  
  mkdir "$pkg_prefix/www/"
  cp -R $PLAN_CONTEXT/../data/* "$pkg_prefix/www/"
#  cp -R $PLAN_CONTEXT/../src/* "$pkg_prefix/www/"
