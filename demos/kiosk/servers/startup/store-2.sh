...
hab svc load --url $PRIMARY_BUILDER --strategy at-once --update-condition track-channel --remote-sup s2d1 --channel store-1 kiosk/kiosk_store
hab svc load --url $PRIMARY_BUILDER --strategy at-once --update-condition track-channel --remote-sup s2d1 --channel store-1 --group store1 kiosk/kiosk_inventory
...
hab svc load --url $PRIMARY_BUILDER --strategy at-once --update-condition track-channel --remote-sup s2d1 --channel s1d1 kiosk/kiosk_coupons
hab svc load --url $PRIMARY_BUILDER --strategy at-once --update-condition track-channel --remote-sup s2d1 --channel s1d1 kiosk/kiosk_hostCompliance
hab svc load --url $PRIMARY_BUILDER --strategy at-once --update-condition track-channel --remote-sup s2d1 --channel s1d1 kiosk/kiosk_appCompliance
