...
hab svc load --url $PRIMARY_BUILDER --strategy at-once --update-condition track-channel --remote-sup s3d1 --channel stable kiosk/kiosk_proxy 
...
###--------------------------------------------------------------
hab svc load --url $PRIMARY_BUILDER --strategy at-once --update-condition track-channel --remote-sup s3d2 --channel stable kiosk/kiosk_proxy 
